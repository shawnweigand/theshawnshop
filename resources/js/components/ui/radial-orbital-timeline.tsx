      ...
      <div className="relative w-full max-w-4xl h-full flex items-center justify-center">
        ...
        >
          ...
          <div className="absolute w-16 h-16 rounded-full bg-gradient-to-br from-primary via-primary/80 to-primary/60 animate-pulse flex items-center justify-center z-10">
            ...
            <div className="w-8 h-8 rounded-full bg-primary/90 backdrop-blur-md"></div>

          </div>



          <div className="absolute w-[560px] h-[560px] rounded-full border border-border/50"></div>
            ...
            return (
              ...
              >
                ...
                {isExpanded && (
                  ...
                  <Card className="absolute top-20 left-1/2 -translate-x-1/2 w-64 bg-card backdrop-blur-lg border-border shadow-xl overflow-visible">
