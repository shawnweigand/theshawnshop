...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: '8 Steps to K8s',
        href: route('8-steps-to-k8s'),
    },
];

export default function EightStepsToK8sPage() {
